...
- **4.6 — Production deployment**: Choose host (Azure, Railway, Render, Fly.io). CI/CD pipeline pushes to staging on master, manual promote to production. Domain, SSL, monitoring (Application Insights or Sentry).
